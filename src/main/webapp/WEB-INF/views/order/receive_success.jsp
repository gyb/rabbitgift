...
<div id="main">
<div class="title">确认收货成功</div>
<div class="content">
<table>
<tr><th>收货时间</th><th colspan="2">商品</th><th>单价</th><th>个数</th><th>总计</th><th>收货信息</th></tr>
<tr>
...
<p>请对买到的商品<a href="<c:url value="/order/rate/${order.id}"/>">进行评价</a>。您的评价对卖家和其它买家都将很有帮助。谢谢</p>
</div>
</div>
