...
<div id="main">
<div class="title"><h2>商品发货</h2></div>
<div class="content">
<fieldset>
<legend>订单信息</legend>
<div class="content">
<table>
<tr><th>支付时间</th><th colspan="2">商品</th><th>单价</th><th>数量</th><th>合计</th><th>收货地址</th></tr>
<tr>
...
<br/>
<c:url value="/order/deliver/${order.id}" var="deliverUrl"/>
<form method="post" action="${deliverUrl}">
